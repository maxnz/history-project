...
import pages.PolishResettlementAct

enum class PageGroup(
    val pages: List<Page>
) {
    YRS_1935_1940(listOf(Kindertransport)),
    YRS_1940_1944(listOf(ExamplePage)),
    YRS_1945_1949(listOf(PolishResettlementAct, ExamplePage, ExamplePage2)),
